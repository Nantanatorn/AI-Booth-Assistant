...
namespace Mediapipe.Unity.Sample.Holistic.UI
{
  public class HolisticTrackingConfig : ModalContents
  {
    ...
    private UIToggle _smoothLandmarksInput;
    private UIToggle _refineFaceLandmarksInput;
    private UIToggle _enableSegmentationInput;
    private UIToggle _smoothSegmentationInput;
    ...
    {
      _smoothLandmarksInput = gameObject.transform.Find(_SmoothLandmarksPath).gameObject.GetComponent<UIToggle>();
    ...
    {
      _refineFaceLandmarksInput = gameObject.transform.Find(_RefineFaceLandmarksPath).gameObject.GetComponent<UIToggle>();
    ...
    {
      _enableSegmentationInput = gameObject.transform.Find(_EnableSegmentationPath).gameObject.GetComponent<UIToggle>();
    ...
    {
      _smoothSegmentationInput = gameObject.transform.Find(_SmoothSegmentationPath).gameObject.GetComponent<UIToggle>();
