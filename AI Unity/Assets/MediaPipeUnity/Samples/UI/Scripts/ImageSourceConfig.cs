...
namespace Mediapipe.Unity.Sample.UI
{
  public class ImageSourceConfig : ModalContents
  {
    ...
    private UIToggle _isHorizontallyFlippedInput;
    ...
    {
      _isHorizontallyFlippedInput = gameObject.transform.Find(_IsHorizontallyFlippedPath).gameObject.GetComponent<UIToggle>();
